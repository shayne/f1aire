...
function updateContainerCompat(
  ...
  if (typeof reconcilerCompat.updateContainerSync === 'function') {
    reconcilerCompat.updateContainerSync(element, container, null, noop)
    reconcilerCompat.flushSyncWork?.()
    return
  }

  reconcilerCompat.updateContainer(element, container, null, noop)
}

function getRootTagCompat(): number {
  const reconcilerCompat = reconciler as typeof reconciler & {
    updateContainerSync?: unknown
  }

  return typeof reconcilerCompat.updateContainerSync === 'function'
    ? ConcurrentRoot
    : LegacyRoot
}
...
export default class Ink {
  ...
  getFrameSnapshot(): string {
    return screenToString(this.frontFrame.screen)
  }
  ...
  render(node: ReactNode): void {
    ...
    updateContainerCompat(tree, this.container)
  }
  ...
  unmount(error?: Error | number | null): void {
    ...
    updateContainerCompat(null, this.container)
