...
// react-reconciler@0.29.x doesn't export NoEventPriority. Keep a local
// sentinel so we can distinguish "no explicit priority set" from actual
// React event priorities at runtime.
